...
with st.sidebar:
    ...
    user_api_key = st.text_input("Enter your Gemini API Key `(Must be Paid account to use '3.1 pro' model`)", type="password")
    model_choice = st.selectbox("Select Model", ["gemini-3.1-pro-preview", "gemini-2.5-flash"], index=0)
